...
```bash
git remote add encore encore://tinycdp-project-plan-f6u2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/tinycdp-project-plan-f6u2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/tinycdp-project-plan-f6u2/settings/integrations/github)
